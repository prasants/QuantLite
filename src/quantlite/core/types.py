...
class DrawdownInfo:
    ...
    def __repr__(self) -> str:
        return f"DrawdownInfo(max_dd={self.max_drawdown:.4f}, duration={self.duration} periods)"
...
class GEVFit:
    ...
    def __repr__(self) -> str:
        return f"GEVFit(shape={self.shape:.4f}, loc={self.loc:.4f}, scale={self.scale:.4f})"
